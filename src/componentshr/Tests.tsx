...
import { FileText, Clock, Calendar, CheckCircle, XCircle, AlertCircle, PlusCircle, Search } from 'lucide-react';
...
export const Tests: React.FC = () => {
  ...
  className="w-full"
  onClick={() => {
    localStorage.setItem('currentTest', JSON.stringify(test)); // Store the current test
    navigate('/test/view'); // Navigate to the test view page
  }}
>
  View Test
</Button>
